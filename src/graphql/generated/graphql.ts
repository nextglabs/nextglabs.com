...
export type Article = Node & {
  ...
  content2?: Maybe<ArticleContent2RichText>;
...
export type ArticleContent2RichText = {
  __typename?: 'ArticleContent2RichText';
  ...
  references: Array<ArticleContent2RichTextEmbeddedTypes>;
  /** Returns plain-text contents of RichText */
  text: Scalars['String'];
};


export type ArticleContent2RichTextReferencesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type ArticleContent2RichTextEmbeddedTypes = Asset;

export type ArticleCreateInput = {
  content: Scalars['String'];
  content2?: InputMaybe<Scalars['RichTextAST']>;
...
export type ProjectManyWhereInput = {
  ...
  databases?: InputMaybe<Array<Databases>>;
  /** Matches if the field array contains *all* items provided to the filter */
  databases_contains_all?: InputMaybe<Array<Databases>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  databases_contains_none?: InputMaybe<Array<Databases>>;
  /** Matches if the field array contains at least one item provided to the filter */
  ...
  frameworks?: InputMaybe<Array<Frameworks>>;
  /** Matches if the field array contains *all* items provided to the filter */
  frameworks_contains_all?: InputMaybe<Array<Frameworks>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  frameworks_contains_none?: InputMaybe<Array<Frameworks>>;
  /** Matches if the field array contains at least one item provided to the filter */
  frameworks_contains_some?: InputMaybe<Array<Frameworks>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  frameworks_not?: InputMaybe<Array<Frameworks>>;
  githubUrl?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  ...
  languages?: InputMaybe<Array<Languages>>;
  /** Matches if the field array contains *all* items provided to the filter */
  languages_contains_all?: InputMaybe<Array<Languages>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  languages_contains_none?: InputMaybe<Array<Languages>>;
  /** Matches if the field array contains at least one item provided to the filter */
  languages_contains_some?: InputMaybe<Array<Languages>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  languages_not?: InputMaybe<Array<Languages>>;
  /** Matches if the field array contains *all* items provided to the filter and order does match */
  libraries?: InputMaybe<Array<Libraries>>;
  /** Matches if the field array contains *all* items provided to the filter */
  libraries_contains_all?: InputMaybe<Array<Libraries>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  libraries_contains_none?: InputMaybe<Array<Libraries>>;
  /** Matches if the field array contains at least one item provided to the filter */
  libraries_contains_some?: InputMaybe<Array<Libraries>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  libraries_not?: InputMaybe<Array<Libraries>>;
  liveUrl?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
...
export enum ProjectOrderByInput {
  ...
  FrameworksAsc = 'frameworks_ASC',
  FrameworksDesc = 'frameworks_DESC',
...
export type ScheduledOperationAffectedDocument = Article | Asset | Page | Project;
...
export type GetPageQuery = { __typename?: 'Query', page?: { __typename?: 'Page', id: string, title: string, content: string, slug?: string | null, locale: Locale } | null };

export type GetPagesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPagesQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'Page', id: string, title: string, content: string, slug?: string | null }> };

export type GetProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProjectsQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', id: string, title: string, description: string, liveUrl?: string | null, githubUrl?: string | null, frameworks: Array<Frameworks>, languages: Array<Languages>, libraries: Array<Libraries>, databases: Array<Databases>, categories: Array<Categories>, updatedAt: any, featuredImage: { __typename?: 'Asset', id: string, url: string, alt?: string | null } }> };


export const GetPageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getPage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"locale"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Locale"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"page"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"locales"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"locale"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"locale"}}]}}]}}]} as unknown as DocumentNode<GetPageQuery, GetPageQueryVariables>;
export const GetPagesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getPages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pages"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"updatedAt_ASC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}}]} as unknown as DocumentNode<GetPagesQuery, GetPagesQueryVariables>;
export const GetProjectsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getProjects"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projects"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"updatedAt_ASC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"liveUrl"}},{"kind":"Field","name":{"kind":"Name","value":"githubUrl"}},{"kind":"Field","name":{"kind":"Name","value":"frameworks"}},{"kind":"Field","name":{"kind":"Name","value":"languages"}},{"kind":"Field","name":{"kind":"Name","value":"libraries"}},{"kind":"Field","name":{"kind":"Name","value":"databases"}},{"kind":"Field","name":{"kind":"Name","value":"categories"}},{"kind":"Field","name":{"kind":"Name","value":"featuredImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"alt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<GetProjectsQuery, GetProjectsQueryVariables>;